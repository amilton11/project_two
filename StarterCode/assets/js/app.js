function makeResponsive(yaxis) {
    ...
    d3.csv("assets/js/merge_df.csv").then(function (waterData) {
        ...
        //     .attr("dy", "1em")
        //     .attr("class", "axisText")
        //     .attr("data-name", "unsafe_water_perct")
        //     .text("Unsafe Water %");
        ...
        //     .attr("dy", "1em")
        //     .attr("class", "axisText")
        //     .attr("data-name", "unsafe_sanitation_perct")
        //     .text("Unsafe Sanitation %");
        var titleLookup = {"unsafe_water_perct":"Unsafe Water %", 
                           "unsafe_sanitation_perct": "Unsafe Sanitation %",
                           "no_handwashing_perct":"No Handwashing %"};
